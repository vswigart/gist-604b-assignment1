...
def main():
    ...
    print("Student: [Victoria Swigart]")
    ...
    print("[GIS blends technical skills with purpose - supporting teams, missions, and communities - to find solutions in everyday life.]")
